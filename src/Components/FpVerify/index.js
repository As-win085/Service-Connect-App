...
const FpVerify = () => {
    ...
    return (
        <div className="w-full max-w-screen-lg mt-6 px-4 mx-auto min-h-screen flex flex-col justify-end item-center pb-8 md:justify-center">
            <h2 className="text-center md:text-lg mx-5 font-smtext-sm md:text-md lg:text-lg font-sm text-[#1D1F2A] mb-6 text-center">
