...
class Banner extends Component {
  ...
  render() {
    ...
    return (
        <div className="md:mx-auto md:m-4 mx-auto w-4/5 flex justify-center items-center bg-white rounded-full shadow-lg shadow-gray dark:shadow-gray-900/50 max-w-lg overflow-hidden border-2 border-black-700 dark:border-black-700">
