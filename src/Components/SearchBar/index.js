...
const SearchBar = () => {
  return (
    <div className="flex items-center bg-[#5c534b] rounded-lg px-4 py-2 shadow-md mt-2 mb-2 mx-8 justify-center md:mx-14 md:px-8 md:py-4 md:w-1/2 lg:w-1/3 md:mx-auto">
