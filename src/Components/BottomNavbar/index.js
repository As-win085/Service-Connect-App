...
const BottomNavbar = () => {
  return (
    <div className="fixed bottom-4 left-1/2 -translate-x-1/2 flex items-center justify-between bg-neutral-700 text-white rounded-2xl px-6 py-3 w-5/6 shadow-lg md:px-8 md:py-5 sm:w-4/6 md:w-1/2 z-50">
